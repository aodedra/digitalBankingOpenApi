...
import com.mob.casestudy.digitalbanking.statidatainsertion.CustomerService;
...
public class DigitalbankingApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CustomerOtp customerOtp = CustomerOtp.builder().customerOtpId(new CustomerOtpId()).otpMessage("This is Opt").otp("123456").otpRetries(1).createdOn(LocalDateTime.now()).expiryOn(LocalDateTime.now()).build();
